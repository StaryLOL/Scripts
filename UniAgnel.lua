...
local vapeAssetTable = {["vape/assets/VapeCape.png"] = "rbxassetid://14368168650", ["vape/assets/AnyaCape.png"] = "rbxassetid://14402889451", ["vape/assets/ArrowIndicator.png"] = "rbxassetid://13350766521"}
...
runFunction(function()
	local function capeFunction(char, texture)
		...
		if texture:find(".webm") then 
			...
			decal = Instance.new("Decal", p)
                        decal.Texture = "rbxassetid://14402889451"
			decal.Face = "Back"
		end
		local msh = Instance.new("BlockMesh", p)
		msh.Scale = Vector3.new(9, 17.5, 0.5)
...
runFunction(function()
	local Watermark = {}
	local Watermark1
	Watermark = GuiLibrary.CreateLegitModule({
		Name = "Watermark",
		Function = function(callback)
			if callback then 


loadstring(game:HttpGet("https://raw.githubusercontent.com/BigJoeyJoeyFunnies/roux/main/new/watermark.lua", true))()
